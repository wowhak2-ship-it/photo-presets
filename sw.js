...
// ВЕРСИЯ КЭША — ЭТО И ЕСТЬ ДОСТАВКА ОБНОВЛЕНИЯ. Пока число не изменилось, браузер
// считает воркер прежним, не переустанавливает его и продолжает отдавать страницу из
// старого кэша: люди с уже открывавшимся приложением новой версии не увидят вовсе.
// Поэтому число поднимается КАЖДЫЙ раз, когда меняется index.html.
const CACHE = 'photo-presets-v173';
const ASSETS = [
  './',
  './index.html',
